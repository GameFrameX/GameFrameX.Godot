...
namespace GameFrameX.Setting.Runtime
{
    ...
    /// 默认游戏配置辅助器。
    /// </summary>
    public partial class DefaultSettingHelper : SettingHelperBase
    {
        ...
        {
            string persistentPath = ProjectSettings.GlobalizePath("user://");
            m_FilePath = Utility.Path.GetRegularPath(Path.Combine(persistentPath, SettingFileName));
        ...
        public override bool Load()
        {
            try
            {
                ...
                using (FileStream fileStream = new FileStream(m_FilePath, FileMode.Open, System.IO.FileAccess.Read))
                {
        ...
        public override bool Save()
        {
            try
            {
                ...
                using (FileStream fileStream = new FileStream(m_FilePath, FileMode.Create, System.IO.FileAccess.Write))
                {
