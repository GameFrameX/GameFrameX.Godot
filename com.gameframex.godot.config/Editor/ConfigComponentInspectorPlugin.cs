...
namespace GameFrameX.Config.Editor
{
    ...
    /// </summary>
    [Tool]
    public partial class ConfigComponentInspectorPlugin : EditorInspectorPlugin
    {
        public override bool _CanHandle(GodotObject @object)
        {
            return @object is ConfigComponent;
        }

        public override void _ParseBegin(GodotObject @object)
        {
            if (!(@object is ConfigComponent configComponent))
            {
                return;
            }

            var infoLabel = new Label();
            infoLabel.Text = "Config Component - Runtime Info";
            ...
            if (!Engine.IsEditorHint())
            {
                ...
                runtimeInfo.Text = $"Config Count: {configComponent.Count}";
