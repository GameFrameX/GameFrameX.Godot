...
pushd "%SCRIPT_DIR%"
dotnet "%TOOLS_ROOT%\Luban.dll" --conf "%CONF%" --target client --dataTarget json --codeTarget cs-simple-json --xargs outputDataDir="%PROJECT_ROOT%\Assets\Bundles\Config" --xargs outputCodeDir="%PROJECT_ROOT%\Assets\Hotfix\Config\Generate"
