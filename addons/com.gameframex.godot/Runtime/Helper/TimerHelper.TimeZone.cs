...
// 迁移备注：时区核心机制迁移自 Unity 基准 com.gameframex.unity/Runtime/Time/TimerHelper.cs（2025-08-28 时区三轴重构）。
// Godot 侧已有 TimerHelper.cs 为旧版本且不可改动，故时区机制独立成本文件。
// 使用 BCL TimeZoneInfo 实现语义对齐，无 UnityEngine 依赖。
