...
// 迁移备注：迁移自 Unity 基准 com.gameframex.unity/Runtime/Time/TimerHelper.Year.TimeZone.cs。
// 基准中的 GetYearEndTime() 已由既有 TimerHelper.Year.cs 提供同名同签名实现，不再重复迁移；
// 该基准方法在内部被 GetYearEndTimestampWithTimeZone() 复用，Godot 侧同样复用既有实现。
