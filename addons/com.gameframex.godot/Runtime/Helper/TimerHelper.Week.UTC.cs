...
// 迁移备注：迁移自 Unity 基准 com.gameframex.unity/Runtime/Time/TimerHelper.Week.UTC.cs。
// 基准中的 GetDayOfWeekTime(DayOfWeek)（基于 UTC 当前时间）已由既有 TimerHelper.Week.cs 提供同名同签名实现，不再重复迁移。
