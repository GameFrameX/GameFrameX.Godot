...
// 迁移备注：迁移自 Unity 基准 com.gameframex.unity/Runtime/Time/TimerHelper.Timestamp.TimeZone.cs。
...
namespace GameFrameX.Runtime
{
    ...
    {
        /// <summary>
        /// 将给定的时间戳转换为相对于纪元的 TimeSpan 对象。
        /// </summary>
        /// <remarks>
        /// Converts the given timestamp to a TimeSpan object relative to the epoch.
        /// </remarks>
        ...
        /// <summary>
        /// 将给定的毫秒时间戳转换为相对于纪元的 TimeSpan 对象。
        /// </summary>
        /// <remarks>
        /// Converts the given millisecond timestamp to a TimeSpan object relative to the epoch.
        /// </remarks>
