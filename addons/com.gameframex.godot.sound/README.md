...
# Game Frame X Sound (Godot)

[![License](https://img.shields.io/github/license/GameFrameX/com.gameframex.godot.sound)](https://github.com/GameFrameX/com.gameframex.godot.sound/blob/main/LICENSE.md)
[![Version](https://img.shields.io/github/v/release/GameFrameX/com.gameframex.godot.sound)](https://github.com/GameFrameX/com.gameframex.godot.sound/releases)
...
GameFrameX Sound — Godot audio management package. Provides organized playback through sound groups with independent mute/volume/priority, async playback with priority queuing, full lifecycle control (stop, pause, resume with fade), spatial audio binding to game entities, and event-driven success/failure notifications.
...
```
addons/com.gameframex.godot.sound/
```
