...
namespace GameFrameX.Localization.Runtime
{
    ...
    public sealed class LocalizationLanguageChangeBeforeEventArgs : GameEventArgs
    {
        ...
        /// 本地化语言改变前事件编号。
        /// </summary>
        public static readonly string EventId = typeof(LocalizationLanguageChangeBeforeEventArgs).FullName;
        ...
        /// <returns>创建的本地化语言改变前事件。</returns>
        public static LocalizationLanguageChangeBeforeEventArgs Create(string oldLanguage, string language)
        {
            LocalizationLanguageChangeBeforeEventArgs localizationLanguageChangeEventArgs = ReferencePool.Acquire<LocalizationLanguageChangeBeforeEventArgs>();
