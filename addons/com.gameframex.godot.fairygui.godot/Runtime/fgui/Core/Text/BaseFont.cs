...
namespace FairyGUI
{
    ...
    public class BaseFont
    {
        ...
        virtual public void DrawGlyph(TextMeshCluster meshCluster, float x, float y2)
        {
        }

        virtual public void DrawLine(TextMeshCluster meshCluster, float x, float y, float width, int fontSize, int type)
        {
        }
        ...
        virtual public void UpdateCacheTextures()
        {
