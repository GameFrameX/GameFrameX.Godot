    ...
    public sealed partial class DownloadComponent : GameFrameworkComponent
    {
        ...
        public override void _Ready()
        {
            if (string.IsNullOrEmpty(componentType))
            {
                ...
                componentType = typeof(DownloadManager).FullName;
            }
        ...
        private void AddDownloadAgentHelper(int index)
        {
            ...
            if (downloadAgentHelper.GetParent() != m_InstanceRoot)
            {
                if (downloadAgentHelper.GetParent() != null)
                {
                    downloadAgentHelper.Reparent(m_InstanceRoot);
                }
                else
                {
                    m_InstanceRoot.AddChild(downloadAgentHelper);
                }
            }
