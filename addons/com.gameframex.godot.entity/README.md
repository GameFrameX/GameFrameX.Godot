...
# Game Frame X Entity (Godot)

[![License](https://img.shields.io/github/license/GameFrameX/com.gameframex.godot.entity)](https://github.com/GameFrameX/com.gameframex.godot.entity/blob/main/LICENSE.md)
[![Version](https://img.shields.io/github/v/release/GameFrameX/com.gameframex.godot.entity)](https://github.com/GameFrameX/com.gameframex.godot.entity/releases)
...
GameFrameX Entity — Godot entity management package. Manages showing, hiding, grouping, and parent-child hierarchy of game entities with async spawning (async/await-based). Integrates with the asset system for resource loading and object pools for instance reuse, with event notifications for show/hide lifecycle.
...
```
addons/com.gameframex.godot.entity/
```
