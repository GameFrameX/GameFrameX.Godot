...
# Game Frame X LuBan (Godot)

[![License](https://img.shields.io/github/license/GameFrameX/com.gameframex.godot.luban)](https://github.com/GameFrameX/com.gameframex.godot.luban/blob/main/LICENSE.md)
[![Version](https://img.shields.io/github/v/release/GameFrameX/com.gameframex.godot.luban)](https://github.com/GameFrameX/com.gameframex.godot.luban/releases)
...
独立游戏前后端一体化解决方案 https://gameframex.doc.alianblank.com/
...
```
addons/com.gameframex.godot.luban/
```
