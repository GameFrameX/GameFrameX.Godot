...
# Game Frame X Scene（Godot）

[![License](https://img.shields.io/github/license/GameFrameX/com.gameframex.godot.scene)](https://github.com/GameFrameX/com.gameframex.godot.scene/blob/main/LICENSE.md)
[![Version](https://img.shields.io/github/v/release/GameFrameX/com.gameframex.godot.scene)](https://github.com/GameFrameX/com.gameframex.godot.scene/releases)
...
```
addons/com.gameframex.godot.scene/
```
