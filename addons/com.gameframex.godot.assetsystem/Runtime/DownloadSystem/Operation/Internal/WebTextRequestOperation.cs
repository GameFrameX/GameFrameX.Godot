...
{
    [AssetSystemPreserve]
    internal class WebTextRequestOperation : WebRequestOperation
    {
        ...
        [AssetSystemPreserve]
        internal WebTextRequestOperation(string url, int timeout = 60, bool appendTimeTicks = false) : base(url, timeout, appendTimeTicks)
        {
        }
