...
{
    [AssetSystemPreserve]
    internal sealed class BundledSceneProvider : ProviderOperation, ISceneLoadController
    {
        ...
        [AssetSystemPreserve]
        public BundledSceneProvider(ResourceManager manager, string providerGUID, AssetInfo assetInfo, SceneLoadParameters loadSceneParams, bool suspendLoad)
        ...
        public override void InternalOnUpdate()
        {
            ...
            {
                if (LoadDependBundleFileOp.IsDone == false || LoadBundleFileOp.IsDone == false)
                {
                    return;
                }
