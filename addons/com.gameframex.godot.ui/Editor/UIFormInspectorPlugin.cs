...
namespace GameFrameX.UI.Editor
{
    ...
    /// </summary>
    [Tool]
    public partial class UIFormInspectorPlugin : EditorInspectorPlugin
    {
        ...
        {
            if (!(@object is UIForm uiForm))
            {
                return;
            }

            var infoLabel = new Label();
            infoLabel.Text = "UI Form Info";
            ...
            if (Engine.IsEditorHint())
            {
                ...
                runtimeInfo.Text = $"Serial ID: {uiForm.SerialId}\n" +
                                   $"Available: {uiForm.Available}\n" +
                                   $"Visible: {uiForm.Visible}";
