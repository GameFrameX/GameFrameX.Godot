...
namespace GameFrameX.Startup.Runtime
{
    ...
    public sealed class StartupUpgradeInfo
    {
        ...
        /// <summary>
        /// 初始化 <see cref="StartupUpgradeInfo"/> 的新实例。
        /// </summary>
        /// <param name="isForce">是否强制升级。</param>
        /// <param name="appDownloadUrl">应用下载地址。</param>
        /// <param name="updateTitle">更新标题。</param>
        /// <param name="updateAnnouncement">更新公告。</param>
