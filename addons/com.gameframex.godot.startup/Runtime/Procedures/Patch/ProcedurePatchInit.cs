...
{
    /// <summary>
    /// 资源包初始化流程。根据游戏运行模式初始化资源包。
    /// </summary>
    /// <remarks>
    /// Patch initialization procedure. Initializes the asset package based on game play mode.
    /// </remarks>
    internal sealed class ProcedurePatchInit : ProcedureBase
    {
        ...
        /// <returns>初始化完成的任务 / Initialization completion task</returns>
        private async Task InitPatchAsync(IFsm<IProcedureManager> procedureOwner)
        {
