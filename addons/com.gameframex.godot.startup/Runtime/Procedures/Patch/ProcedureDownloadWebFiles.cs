...
{
    /// <summary>
    /// 执行资源文件下载流程。启动下载器进行资源文件下载。
    /// </summary>
    /// <remarks>
    /// Download web files procedure. Launches the downloader to download resource files.
    /// </remarks>
    internal sealed class ProcedureDownloadWebFiles : ProcedureBase
    {
        ...
        protected internal override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            BeginDownloadAsync(procedureOwner);
        }
        ...
        /// <returns>下载完成任务 / Download completion task</returns>
        private async Task BeginDownloadAsync(IFsm<IProcedureManager> procedureOwner)
        {
